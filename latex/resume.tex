...
% resumeTrioHeadingTitle renders three elements in three columns with second element being italicized and first element bolded, can be used for projects with three elements
\newcommand{\resumeTrioHeadingTitle}[4]{%
  \item\small{%
    \makebox[\linewidth]{%
      \makebox[0.33\linewidth][l]{\textbf{#1} }%
      \makebox[0.34\linewidth][c]{\textit{#2} }%
...
% resumeDuoHeading renders four elements in a two columns, can be used for experience and projects with two elements
...
\resumeQuadHeadingDetails{\href{https://www.line.me/}{LINE Taiwan Limited}}{Mar. 2026 -- Present}
  {Software Engineer Intern}
    \resumeItemListStart{}
      \resumeItem{Built high-performance LINE Shopping RESTful/gRPC microservices using \textbf{Spring Boot}, \textbf{Redis}, and \textbf{Kafka} to ensure service reliability.}
      \resumeItem{Collaborated in a \textbf{20-member Scrum team} and aligned API contracts and dependencies across \textbf{multiple product squads}.}
      \resumeItem{Selected as a LINE Graduation Sharing Session panel speaker, presenting real-world challenges to over 120 aspiring developers.}
    \resumeItemListEnd{}
  \resumeQuadHeadingDetails{\href{https://sqlab.web.nycu.edu.tw/}{Software Quality Lab}}{Sept. 2025 -- Jan. 2026}
  ...
  \resumeQuadHeadingDetails{\href{http://acm.cs.nycu.edu.tw/}{Applied Computing and Multimedia Lab}}
  {Sept. 2024 -- Aug. 2025}{Undergraduate Researcher}
    \resumeItemListStart{}
...
\section{Projects}
  \resumeHeadingListStart{}
    ...
    \resumeTrioHeadingTitle{SDC Core System}{}{\href{https://github.com/NYCU-SDC/core-system-backend}{\uline{Source Code}}}{Backend Engineer}
      \resumeItemListStart{}
        ...
        \resumeItem{Streamlined CI/CD pipeline using Docker and integrated unit tests, integration tests, and end-to-end tests to ensure reliability.}
        \resumeItem{Integrated PostgreSQL databases and multi-environment configs for scalable, maintainable infrastructure.}
        \resumeItemListEnd{}

    \resumeTrioHeadingTitle{Koreji}{}{\href{https://github.com/kore-ji}{\uline{Source Code}}}{Project Manager / Frontend Engineer / Qualitative Researcher}
      \resumeItemListStart{}
        \resumeItem{Independently designed and developed a prototype for an AI scheduler App based on \textbf{Expo} architecture.}
        \resumeItem{Integrated \textbf{FastAPI} and \textbf{PostgreSQL}, leveraging LLM to enable \textbf{context-aware recommendations and AI scheduling}.}
      \resumeItemListEnd{}
...
\section{Extracurricular Experiences}
  \resumeHeadingListStart{}
    \resumeQuadHeadingDetails{\href{https://sdc.nycu.club}{NYCU Software Development Club}}{Oct. 2023 -- Jul. 2026}
  {Vice President}
    \resumeItemListStart{}
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{}{ Python, C++, Go, JavaScript, TypeScript, Java, Dart, HTML, CSS, Verilog, LabVIEW, Swift}
    \resumeSectionType{Frameworks \& Libraries}{}{React.js, Vue.js, Astro, React Native (Expo), Armeria, Tailwind CSS, Spring Boot, Flutter, OpenGL}
    \resumeSectionType{Tools \& Technologies}{}{Git, PostgreSQL, MySQL, MongoDB, Docker, Redis, Kafka, Flagr, Harbor, Jenkins, Grafana, Figma}
  \resumeHeadingListEnd{}
%--------------------------------------------
\end{document}
